...
grid()
% text(-82.209, 39.537, 'a_0 Path', FontWeight='bold', FontSize=18)
...
quiver(AC0_lon(i), AC0_lat(i), cosd(90-AC0_hdg(i)), sind(90-AC0_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC0_lon(i), AC0_lat(i), 100, 'o', 'filled', 'blue')
text(AC0_lon(i)+1.5*r, AC0_lat(i), sprintf('t_5'), 'FontSize', 18, FontWeight= 'bold')

i = 2251;
quiver(AC0_lon(i), AC0_lat(i), cosd(90-AC0_hdg(i)), sind(90-AC0_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC0_lon(i), AC0_lat(i), 100, 'o', 'filled', 'blue')
text(AC0_lon(i)+1.5*r, AC0_lat(i), sprintf('t_6'), 'FontSize', 18, FontWeight= 'bold')
...
r = 0.0004144027532220207;
grid()
% text(-82.209, 39.537, 'a_1 Path', FontWeight='bold', FontSize=18)
...
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_0'), 'FontSize', 18, FontWeight= 'bold')

i =1562;
quiver(AC1_lon(i), AC1_lat(i), cosd(90-AC1_hdg(i)), sind(90-AC1_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC1_lon(i), AC1_lat(i), 100, 'o', 'filled', 'green')
text(AC1_lon(i)-11*r, AC1_lat(i), sprintf('t_1'), 'FontSize', 18, FontWeight= 'bold')
% 
i = 1650;
quiver(AC1_lon(i), AC1_lat(i), cosd(90-AC1_hdg(i)), sind(90-AC1_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC1_lon(i), AC1_lat(i), 100, 'o', 'filled', 'green')
text(AC1_lon(i)-11*r, AC1_lat(i), sprintf('t_2'), 'FontSize', 18, FontWeight= 'bold')

i = 1800;
quiver(AC1_lon(i), AC1_lat(i), cosd(90-AC1_hdg(i)), sind(90-AC1_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC1_lon(i), AC1_lat(i), 100, 'o', 'filled', 'green')
text(AC1_lon(i)-11*r, AC1_lat(i), sprintf('t_3'), 'FontSize', 18, FontWeight= 'bold')
...
quiver(AC1_lon(i), AC1_lat(i), cosd(90-AC1_hdg(i)), sind(90-AC1_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC1_lon(i), AC1_lat(i), 100, 'o', 'filled', 'green')
text(AC1_lon(i)-11*r, AC1_lat(i), sprintf('t_4'), 'FontSize', 18, FontWeight= 'bold')

i = 2125;
quiver(AC1_lon(i), AC1_lat(i), cosd(90-AC1_hdg(i)), sind(90-AC1_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC1_lon(i), AC1_lat(i), 100, 'o', 'filled', 'green')
text(AC1_lon(i)-11*r, AC1_lat(i), sprintf('t_5'), 'FontSize', 18, FontWeight= 'bold')

i = 2251;
quiver(AC1_lon(i), AC1_lat(i), cosd(90-AC1_hdg(i)), sind(90-AC1_hdg(i)), 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(AC1_lon(i), AC1_lat(i), 100, 'o', 'filled', 'green')
text(AC1_lon(i)-11*r, AC1_lat(i), sprintf('t_6'), 'FontSize', 18, FontWeight= 'bold')
...
r = 0.0004144027532220207;
grid()
% text(-82.209, 39.537, 'e_0 Path', FontWeight='bold', FontSize=18)
...
quiver(EM0_lon(i), EM0_lat(i), 0, 1, 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(EM0_lon(i), EM0_lat(i), 100, '^',  'filled', 'red')
text(EM0_lon(i)+1.5*r, EM0_lat(i), sprintf('t_5'), 'FontSize', 18, FontWeight='bold')

i = 2251;
rectangle('Position', [EM0_lon(i)-r, EM0_lat(i)-r, 2*r, 2*r], 'Curvature', [1, 1], 'EdgeColor','r', 'LineWidth',3)
quiver(EM0_lon(i), EM0_lat(i), 0, 1, 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(EM0_lon(i), EM0_lat(i), 100, '^',  'filled', 'red')
text(EM0_lon(i)+1.5*r, EM0_lat(i), sprintf('t_6'), 'FontSize', 18, FontWeight='bold')
...
grid()
i = 1400;
% text(-82.21, 39.537, 'Total Path', FontWeight='bold', FontSize=17)
...
text(AC0_lon(i)+1.5*r, AC0_lat(i), sprintf('a_0, t_1'), 'FontSize', 18, FontWeight= 'bold')
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_1'), 'FontSize', 18, FontWeight= 'bold')
...
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_2'), 'FontSize', 18, FontWeight= 'bold')
text(EM0_lon(i)+1.5*r, EM0_lat(i), sprintf('e_0, t_2'), 'FontSize', 18, FontWeight= 'bold')

% plot([AC1_lon(i), AC1_lon(i)+1.5*r], [AC1_lat(i), AC1_lat(i)+1.5.75*r], 'LineStyle','-', 'Color','k')
...
text(AC0_lon(i)+1.5*r, AC0_lat(i)+1*r, sprintf('a_0, t_3'), 'FontSize', 18, FontWeight= 'bold')
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_3'), 'FontSize', 18, FontWeight= 'bold')
text(EM0_lon(i)+1.5*r, EM0_lat(i)-1*r, sprintf('e_0, t_3'), 'FontSize', 18, FontWeight= 'bold')
...
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_4'), 'FontSize', 18, FontWeight= 'bold')
text(EM0_lon(i)+1.5*r, EM0_lat(i)-6*r, sprintf('e_0, t_4'), 'FontSize', 18, FontWeight= 'bold')
...
text(AC0_lon(i)+1.5*r, AC0_lat(i), sprintf('a_0, t_5'), 'FontSize', 18, FontWeight= 'bold')
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_5'), 'FontSize', 18, FontWeight= 'bold')
text(EM0_lon(i)-15*r, EM0_lat(i), sprintf('e_0, t_5'), 'FontSize', 18, FontWeight='bold')
...
text(AC0_lon(i)+1.5*r, AC0_lat(i)-r, sprintf('a_0, t_6'), 'FontSize', 18, FontWeight= 'bold')
text(AC1_lon(i)-15*r, AC1_lat(i), sprintf('a_1, t_6'), 'FontSize', 18, FontWeight= 'bold')
text(EM0_lon(i)+1.5*r, EM0_lat(i)-r, sprintf('e_0, t_6'), 'FontSize', 18, FontWeight='bold')

% plot([AC1_lon(i), AC1_lon(i)-15*r], [AC1_lat(i), AC1_lat(i)+6*r], 'Color', 'k')
% plot([AC0_lon(i), AC0_lon(i)+1.5*r], [AC0_lat(i), AC0_lat(i)+6*r], 'Color', 'k')
