...
AC0_lon2 = AC0(1, 1:1:800);
AC0_lat2 = AC0(2, 1:1:800);
...
text(AC0_lon(i), AC0_lat(i)-5*r, sprintf('t_1'), 'FontSize', 18, FontWeight= 'bold')

i  = 208;
quiver(AC0_lon(i), AC0_lat(i), cosd(90-AC0_hdg(i)), sind(90-AC0_hdg(i)), 0.001, 'Color' , purple, 'LineWidth', 4, 'MaxHeadSize',4)

scatter(AC0_lon(i), AC0_lat(i), 100, 'o', 'filled', 'blue')
text(AC0_lon(i)+1.5*r, AC0_lat(i)+3*r, sprintf('t_2'), 'FontSize', 18, FontWeight= 'bold')
...
ylim([39.5875, 39.6175])% ylabel('Latitude', FontName='Times')
...
i=1;
plot([EM0_lon(1), EM0_lon(800)], [EM0_lat(1) EM0_lat(800)], 'LineWidth', 3, 'Color', 'red')
...
text(EM0_lon(i)-7.5*r, EM0_lat(i)-5*r, sprintf('e_0,t_0'), 'FontSize', 18, FontWeight= 'bold')

i =100;
rectangle('Position', [EM0_lon(i)-r, EM0_lat(i)-r, 2*r, 2*r], 'Curvature', [1, 1], 'EdgeColor','r', 'LineWidth',2)
quiver(EM0_lon(i), EM0_lat(i), 1, 0, 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(EM0_lon(i), EM0_lat(i), 100, '^',  'filled', 'red')
text(EM0_lon(i), EM0_lat(i) - 5*r, sprintf('t_1'), 'FontSize', 18, FontWeight= 'bold')

i  = 208;
rectangle('Position', [EM0_lon(i)-r, EM0_lat(i)-r, 2*r, 2*r], 'Curvature', [1, 1], 'EdgeColor','r', 'LineWidth',2)
quiver(EM0_lon(i), EM0_lat(i), 1, 0, 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(EM0_lon(i), EM0_lat(i), 100, '^',  'filled', 'red')
text(EM0_lon(i), EM0_lat(i) - 5*r, sprintf('t_2'), 'FontSize', 18, FontWeight= 'bold')

i  = 400;
rectangle('Position', [EM0_lon(i)-r, EM0_lat(i)-r, 2*r, 2*r], 'Curvature', [1, 1], 'EdgeColor','r', 'LineWidth',2)
quiver(EM0_lon(i), EM0_lat(i), 1, 0, 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
scatter(EM0_lon(i), EM0_lat(i), 100, '^',  'filled', 'red')
text(EM0_lon(i), EM0_lat(i) - 5*r, sprintf('t_3'), 'FontSize', 18, FontWeight= 'bold')

% i  = 400;
% rectangle('Position', [EM0_lon(i)-r, EM0_lat(i)-r, 2*r, 2*r], 'Curvature', [1, 1], 'EdgeColor','r', 'LineWidth',3)
% quiver(EM0_lon(i), EM0_lat(i), 1, 0, 0.001, 'Color', purple, 'LineWidth', 4, 'MaxHeadSize',4)
% scatter(EM0_lon(i), EM0_lat(i), 100, '^',  'filled', 'red')
% text(EM0_lon(i), EM0_lat(i) - 5*r, sprintf('t_4'), 'FontSize', 18, FontWeight='bold')

set(gca, 'XTickLabel', [], 'YTickLabel', []);
xlim([EM0_lon(1)-0.005, EM0_lon(401)+0.005])
% % ylim([AC1_lat(1)-0.0015, EM0_lat(401)+0.0001])
ylim([39.5875, 39.6175])
...
% text(EM0_lon(i), EM0_lat(i) - 5*r, sprintf('e_0,t_4'), 'FontSize', 18, FontWeight='bold')
