...
text(AC0_lon(i)-21*r, AC0_lat(i), sprintf('AC0, t_2'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(AC1_lon(i)+3*r, AC1_lat(i)+2*r, sprintf('AC1, t_2'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
...
text(AC0_lon(i)-21*r, AC0_lat(i), sprintf('AC0, t_3'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(AC1_lon(i)-21*r, AC1_lat(i), sprintf('AC1, t_3'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
...
text(AC0_lon(i)+3*r, AC0_lat(i)+2*r, sprintf('AC0, t_4'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(AC1_lon(i)+3*r, AC1_lat(i), sprintf('AC1, t_4'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(EM0_lon(i)+3*r, EM0_lat(i)-3.5*r, sprintf('EX0, t_4'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
...
text(AC0_lon(i)-21*r, AC0_lat(i), sprintf('AC0, t_5'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(AC1_lon(i)+3*r, AC1_lat(i), sprintf('AC1, t_5'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(EM0_lon(i)+3*r, EM0_lat(i), sprintf('EX0, t_5'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
...
text(AC0_lon(i)+1.5*r, AC0_lat(i)+5*r, sprintf('AC0, t_6'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(AC1_lon(i)-25*r, AC1_lat(i)+7.5*r, sprintf('AC1, t_6'), 'FontSize', 18, FontName='Times', FontWeight= 'bold')
text(EM0_lon(i)+3*r, EM0_lat(i), sprintf('EX0, t_6'), 'FontSize', 18, FontName='Times', FontWeight='bold')
