...
if __name__ == "__main__":
    ...
    ax.text(nodes1[0][0]+5,nodes1[1][0]+5,  r'$\bf{p_0}$')
    ax.text(optim_sol[0]+0.25,optim_sol[1],  r'$\bf{p_1}$')
    ax.text(nodes1[0][2]+0.25,nodes1[1][2],  r'$\bf{p_2}$')
    ax.text(nodes1[0][2]-145,nodes1[1][2]+55,  r'Bezier TOA=5')

    # dist = np.hypot(nodes1[1][0]- nodes1[1][2], nodes1[0][0] - nodes1[0][2] )
    # t = dist/velocity
    # print(t)
    ax.text(nodes1[0][0]+10,nodes1[1][0]-20,  r'Straight Line TOA=4.12')
